        ...
        <div className="relative">
            ...
            <div className='mx-auto max-w-7xl px-4 my-40 sm:py-20 lg:px-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 my-16'>
                    ...
                    {/* COLUMN-1 */}
                    <div>
                        <Image src="/images/dedicated/nelson.png" alt="man-icon" width={450} height={900} className="mx-auto md:mx-0 rounded-3xl" />
                    </div>

                    {/* COLUMN-2 */}
                    <div className="relative">
                        <Image src="images/dedicated/comma.svg" alt="comma-image" width={200} height={106} className="absolute comma-pos hidden lg:block" />
                        <h2 className="text-4xl lg:text-65xl pt-4 font-bold sm:leading-tight mt-3 text-center lg:text-start">Dedicated to share wealth amongst everyone</h2>
                        ...
                        <p className="text-2xl font-semibold mt-4 ml-3 text-left lg:text-start"> Nelson Estevão, CEO</p>
                    </div>
